...
- (void)viewDidLoad
{
    ...
    if ([[SHHunt sharedHunt] hasCustomStartScreen]) {
        ...
        NSString *cString = [[[[[SHHunt sharedHunt] customStartScreenData] objectForKey:@"finish_background_color"]     stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]] uppercaseString];
        ...
        self.redeemView.backgroundColor = [UIColor colorWithRed:((float) r / 255.0f)
